...
export default function SearchFiltersComponent({ 
  ...
  return (
    <>
      ...
      {/* Sidebar Filters */}
      <Card className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 sticky top-24">
        ...
        <div className="mb-6">
          ...
          <RadioGroup 
            ...
            onValueChange={(value) => setFilters({ ...filters, duration: value as any })}
          >
            <div className="flex items-center space-x-2">
              ...
              <div key={level} className="flex items-center space-x-2">
                <Checkbox 
                  ...
                  onCheckedChange={(checked) => 
                    setFilters({ ...filters, level: checked ? level as any : '' })
                  }
                />
        ...
        {/* Trusted Channels */}
        <div>
          <h4 className="text-sm font-medium text-slate-700 mb-3">Trusted Channels</h4>
          <div className="space-y-2">
                ...
                <Checkbox 
                  ...
                  onCheckedChange={(checked) => {
                    if (checked) {
                      ...
                      setFilters({ 
                        ...filters, 
                        channels: filters.channels.filter(id => id !== channel.id) 
                      });
                    }
                  }}
                />
                <Label htmlFor={channel.id} className="text-sm text-slate-600">
                  {channel.name}
                </Label>
              </div>
            ))}
